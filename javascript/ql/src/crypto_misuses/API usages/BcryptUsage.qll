...
class BcryptUsage extends CryptoAPIUsage {
    ...
    BcryptUsage(){
        exists(DataFlow::SourceNode mod |
            (mod = DataFlow::moduleImport("bcrypt") or mod = DataFlow::moduleImport("bcryptjs"))
    ...
    override string getCryptoAPIName() { result = "Bcrypt" }
