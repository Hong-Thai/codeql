...
where mod = DataFlow::moduleImport("tweetnacl") and call = mod.getAPropertyRead()
and crypto_api_name = "tweetnacl" and function_name = "tweetnacl."+getPropertiesAll(call)
