...
where mod = DataFlow::moduleImport("crypto") and call = mod.getAPropertyRead("webcrypto").getAPropertyRead("subtle").getAMethodCall()
and crypto_api_name = "NodeJsCrypto" and function_name = "webcrypto.subtle." + call.getCalleeName()
