...
from DataFlow::SourceNode mod, DataFlow::CallNode call, DataFlow::SourceNode crypto, string crypto_api_name, string function_name, Location reference, string description, string path, int numArgs, string arg0, string arg1, string arg2, string arg3, string arg4, string arg5, string arg6
where 
((mod = DataFlow::globalVariable("window") and crypto = mod.getAPropertyRead("crypto"))
or
(crypto = DataFlow::globalVariable("crypto")))
and call = crypto.getAMethodCall()
