...
from DataFlow::SourceNode mod, DataFlow::CallNode call, DataFlow::SourceNode crypto, DataFlow::SourceNode subtle, string crypto_api_name, string function_name, Location reference, string description, int numArgs, string arg0, string arg1, string arg2, string arg3, string arg4, string arg5, string arg6, string arg7
